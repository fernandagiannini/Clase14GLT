const books = [
  ...
  const filterBookByAuthor = (array, nameAuthor) => {
    return array.filter(element => element.author === nameAuthor) 
  }

  const booksByAuthor = filterBookByAuthor(books, 'Alejo Carpentier')
